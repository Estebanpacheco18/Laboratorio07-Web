...
export const isModerator = async (req, res, next) => {
  try {
    ...
    // Si el usuario tiene el rol de 'moderator', pasamos al siguiente
    // middleware
    if (moderatorRole) {
      next();
      return;
    ...
    // Si el usuario no tiene el rol de 'moderator', respondemos con un
    // error 403
...
export const isModeratorOrAdmin = async (req, res, next) => {
  try {
    ...
    // Si el usuario tiene el rol de 'admin' o 'moderator', pasamos al
